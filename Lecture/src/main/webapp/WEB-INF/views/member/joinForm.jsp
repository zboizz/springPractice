...
email : <input name="email" value="aaa@naver.com"><br/>
<input type="submit" value="JOIN">
</form><p/>
<form action="join1" method="post">
id : <input name="id" value="aaa2"><br/>
pwd : <input name="pwd" value="1234"><br/>
name : <input name="name" value="홍길동2"><br/>
email : <input name="email" value="aaa2@naver.com"><br/>
<input type="submit" value="JOIN">
</form><p/>
</body>
</html>
